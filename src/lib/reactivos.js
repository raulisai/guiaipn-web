export const reactivos = [
  ...
  },
  {
    ...
    opciones: {
      a: "\\frac{1}{4}\\sqrt{xy^3}",
      b: "\\frac{1}{2\\sqrt{xy^3}}",
      c: "\\frac{1}{4}x^2y^3",
      d: "-xy",
    },
    id: "2024Algebra12",
  ...
  },
  {
    ...
    opciones: {
      a: "x^2+9",
      b: "x^2-9",
      c: "\\frac{\\sqrt{x^2-9}}{x-2\\sqrt{3}}",
      d: "\\left(x+2\\sqrt{3}\\right)\\sqrt{x^2-9}",
    },
    id: "2024Algebra18",
    resuesta: "b",
    explicacion: "void", imgActive: false, lengMathPregunta: true, lengMathOpciones: true
  ...
  },
  {
    ...
    opciones: {
      a: "H_0(0)=0,\\; H_2(1)=1",
      b: "H_0(0)=0,\\; H_2(1)=-1",
      c: "H_0(0)=\\frac{1}{\\sqrt{2}},\\; H_2(1)=-1",
      d: "H_0(0)=-1,\\; H_2(1)=-\\frac{1}{\\sqrt{2}}",
    },
    id: "2024Algebra27",
    resuesta: "c",
    explicacion: "void", imgActive: false, lengMathPregunta: true, lengMathOpciones: true
  ...
  },
  {
    ...
    opciones: {
      ...
      c: "x=-\\frac{11}{2}, y=-\\frac{11}{2}",
      d: "x=-\\frac{13}{2}, y=-\\frac{13}{2}",
    },
    id: "2024Algebra33",
    resuesta: "d",
    explicacion: "void", imgActive: false, lengMathPregunta: true, lengMathOpciones: true
  ...
  },
  {
    ...
    opciones: {
      a: "x=\\frac{7}{2}, y=-\\frac{5}{2}",
      b: "x=-\\frac{9}{2}, y=\\frac{7}{2}",
      c: "x=\\frac{9}{2}, y=-\\frac{7}{2}",
      d: "x=-\\frac{7}{2}, y=\\frac{5}{2}",
    },
    id: "2024Algebra40",
    resuesta: "c",
    explicacion: "void", imgActive: false, lengMathPregunta: true, lengMathOpciones: true
  ...
  },
  {
    ...
    opciones: {
      ...
      c: "\\frac{2}{3}\\sqrt[3]{2},\\;3\\sqrt{2},\\;\\frac{2}{3}\\sqrt{3},\\;\\sqrt{2},\\;\\frac{1}{\\sqrt{2}}",
      d: "\\frac{2}{3}\\sqrt[3]{2},\\;\\frac{2}{3}\\sqrt{3},\\;3\\sqrt{2},\\;\\sqrt{2},\\;\\frac{1}{\\sqrt{2}}",
    },
    id: "2024Algebra04",
    resuesta: "a",
    explicacion: "void", imgActive: false, lengMathPregunta: true, lengMathOpciones: true
  ...
  },
  {
    ...
    opciones: {
      ...
      c: "\\frac{\\sqrt[3]{2n}-5}{\\frac{1}{5}(2n+1)^2-(2n+3)^2}",
      d: "\\frac{\\frac{1}{5}\\cdot\\sqrt[3]{n}-5}{(2n+1)^2-(2n+3)^2}",
    },
    id: "2024Algebra09",
    resuesta: "b",
    explicacion: "void", imgActive: false, lengMathPregunta: true, lengMathOpciones: true
  ...
  },
  {
    ...
    opciones: {
      ...
      c: "Lanzar un dado y observar el número",
      d: "Elegir un nombre al azar de una lista",
    },
  ...
  {
    pregunta:
      "Calcular la probabilidad de que al seleccionar una pieza al azar ésta sea defectuosa.",
    opciones: {
      a: "\\frac{2}{25}",
      b: "\\frac{2}{75}",
      c: "\\frac{3}{100}",
  ...
  {
    pregunta:
      "\\text{Calcular la probabilidad del evento } A\\cap B \\text{ si } P(A)=\\frac{1}{5},\\; P(B)=\\frac{1}{3} \\text{ y } A \\text{ y } B \\text{ son independientes.}",
    opciones: {
      a: "\\frac{1}{15}",
      b: "\\frac{1}{8}",
      c: "\\frac{1}{2}",
  ...
  {
    pregunta:
      "\\text{Dadas las muestras de datos, determinar cuáles tienen la misma varianza.}",
  ...
  {
    pregunta:
      "\\text{Calcular la probabilidad de que al seleccionar una pieza se encuentre defectuosa.}",
    opciones: {
      a: "\\frac{2}{25}",
      b: "\\frac{2}{75}",
      c: "\\frac{3}{100}",
  ...
  {
    pregunta:
      "\\text{Calcular la probabilidad del evento } A\\cap B \\text{ si } P(A)=\\frac{1}{5}, \\; P(B)=\\frac{1}{3} \\text{ y } A, B \\text{ son independientes.}",
    opciones: {
      a: "\\frac{1}{15}",
      b: "\\frac{1}{8}",
      c: "\\frac{1}{2}",
  ...
  {
    pregunta:
      "\\text{Calcular la probabilidad del evento } A\\cap B \\text{ si } P(A)=\\frac{1}{5},\\; P(B)=\\frac{1}{3}, \\text{ con } A,B \\text{ independientes.}",
    opciones: {
      a: "\\frac{1}{15}",
      b: "\\frac{1}{8}",
      c: "\\frac{1}{2}",
  ...
  },
  {
    ...
    resuesta: "c",
    explicacion: "void",
    imgActive: false, lengMathPregunta: true, lengMathOpciones: true
  },
  {
    pregunta:
