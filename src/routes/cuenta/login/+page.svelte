...
<section
	class="w-full min-h-screen bg-gradient-to-b from-[#171717] via-[#171717] to-[#171717] py-10 md:py-20 flex items-center justify-center px-4"
>
			...
			>
				...
				{#if showConfirmationMessage}
					...
					>
						...
						<div>
							...
							<p>
								Hemos enviado un correo de confirmación a <span class="font-medium text-cyan-300"
									>{email}</span
				...
				{:else}
					<form on:submit={handleSubmit} class="space-y-5">
						{#if !isLoginMode}
							<div in:fly={{ y: 10, duration: 300, delay: 100 }} out:fade={{ duration: 200 }}>
