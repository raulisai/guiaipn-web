...
<div class="progress-container bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-lg shadow-lg card_color">
...
<style>
  .progress-container {
    ...
    box-shadow: 0 4px 24px 0 rgba(0,0,0,0.10), 0 1.5px 4px 0 rgba(59,130,246,0.05);
    color: #e5e7eb;
    width: 100%;
    max-width: 100%;
